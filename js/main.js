...
function drawRectangulo() {
  ...
  function drawCubBezier() {
    const canvasCubBezier = document.getElementById("canvasCubBezier");
    if (canvasCubBezier.getContext) {
      const ctx = canvasCubBezier.getContext("2d");
  ...
  function drawCuadBezier() {
    const canvasCuadBezier = document.getElementById("canvasCuadBezier");
    if (canvasCuadBezier.getContext) {
      const ctx = canvasCuadBezier.getContext("2d");
  ...
  function drawCombination() {
    const canvasCombination = document.getElementById("canvasCombination");
    if (canvasCombination.getContext) {
      const ctx = canvasCombination.getContext("2d");
      ctx.fillStyle = "Yellow";
